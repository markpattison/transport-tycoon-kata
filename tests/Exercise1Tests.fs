...
let ``logged events are as expected`` ()=
    ...
    let expected = """{"event": "LOAD", "time": 0, "transport_id": 0, "kind": TRUCK", "location": "FACTORY", "cargo": {"cargo_id": 0, "destination": A, "origin": "FACTORY"}}
{"event": "LOAD", "time": 0, "transport_id": 1, "kind": TRUCK", "location": "FACTORY", "cargo": {"cargo_id": 1, "destination": B, "origin": "FACTORY"}}
...
{"event": "UNLOAD", "time": 1, "transport_id": 0, "kind": TRUCK", "location": "PORT", "cargo": {"cargo_id": 0, "destination": A, "origin": "FACTORY"}}
{"event": "LOAD", "time": 1, "transport_id": 2, "kind": SHIP", "location": "PORT", "cargo": {"cargo_id": 0, "destination": A, "origin": "FACTORY"}}
...
{"event": "UNLOAD", "time": 5, "transport_id": 2, "kind": SHIP", "location": "A", "cargo": {"cargo_id": 0, "destination": A, "origin": "FACTORY"}}
{"event": "UNLOAD", "time": 5, "transport_id": 1, "kind": TRUCK", "location": "B", "cargo": {"cargo_id": 1, "destination": B, "origin": "FACTORY"}}
